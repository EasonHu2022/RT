	...
	swapChain_(swapChain)
{
	...
	auto& descriptorSets = descriptorSetManager_->get_descriptorSets();
	...
	std::vector<VkPipelineShaderStageCreateInfo> shaderStages =
	{
		...
		missShader.create_shaderStage(VK_SHADER_STAGE_MISS_BIT_KHR),
		closestHitShader.create_shaderStage(VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR),
...
RayTracingPipeline::~RayTracingPipeline()
{
	...
	{
		vkDestroyPipeline(swapChain_.get_device().Handle(), pipeline_, nullptr);
		pipeline_ = nullptr;
	}
...
{
	return descriptorSetManager_->get_descriptorSets().Handle(index);
}
